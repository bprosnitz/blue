...
// THE REMAINDER SHOULD BE REMOVED ONCE ALEX'S VDL VALUE
// CHANGE GOES IN.
class VdlComplex64 {
  static final VdlType vdlType = VdlTypes.Complex64;
}
class VdlComplex128 {
...
// Note: because type information is mainly for the static checker,
// there is one static initializer for all T and we can't definte a static
// final vdlType field.
class VdlOptional<T> {
  T value;
  VdlOptional(this.value);
}

class VdlTypes {
  static VdlType Any = _createPrimitiveType(VdlKind.Any);
  static VdlType Byte = _createPrimitiveType(VdlKind.Byte);
  static VdlType Bool = _createPrimitiveType(VdlKind.Bool);
  static VdlType Uint16 = _createPrimitiveType(VdlKind.Uint16);
  static VdlType Uint32 = _createPrimitiveType(VdlKind.Uint32);
  static VdlType Uint64 = _createPrimitiveType(VdlKind.Uint64);
  static VdlType Int16 = _createPrimitiveType(VdlKind.Int16);
  static VdlType Int32 = _createPrimitiveType(VdlKind.Int32);
  static VdlType Int64 = _createPrimitiveType(VdlKind.Int64);
  static VdlType Float32 = _createPrimitiveType(VdlKind.Float32);
  static VdlType Float64 = _createPrimitiveType(VdlKind.Float64);
  static VdlType Complex64 = _createPrimitiveType(VdlKind.Complex64);
  static VdlType Complex128 = _createPrimitiveType(VdlKind.Complex128);
  static VdlType String = _createPrimitiveType(VdlKind.String);
  static VdlType TypeObject = _createPrimitiveType(VdlKind.TypeObject);
